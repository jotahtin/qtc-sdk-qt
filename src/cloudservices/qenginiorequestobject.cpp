...
** Private
*/
QEnginioRequestObjectPrivate::QEnginioRequestObjectPrivate()
    :QRestRequestObjectPrivate(QSharedPointer<QRestRequestShared>
                               (new QEnginioRequestShared()))
{
}

QEnginioRequestObjectPrivate::QEnginioRequestObjectPrivate(QtCloudServices::RESTOperation aOperation, QString aPath)
    :QRestRequestObjectPrivate(QSharedPointer<QRestRequestShared>
                               (new QEnginioRequestShared(aOperation,aPath)))
{
...
QEnginioRequestObject::QEnginioRequestObject(QtCloudServices::RESTOperation aOperation, QString aPath, QObject *aParent)
: QRestRequestObject(*new QEnginioRequestObjectPrivate(aOperation,aPath),aParent)
{
