...
#ifndef QCLOUDSERVICES_QENGINIOREQUEST_SHARED_P_H
...
class QTCLOUDSERVICES_EXPORT QEnginioRequestShared : public QRestRequestShared {
    Q_OBJECT
private:
    Q_DISABLE_COPY(QEnginioRequestShared)
public:
    QEnginioRequestShared();
...
#endif /* QCLOUDSERVICES_QENGINIOREQUEST_SHARED_P_H */
