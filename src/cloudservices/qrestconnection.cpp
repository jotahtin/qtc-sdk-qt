...
QRestConnection::QRestConnection(QRestConnectionObject *aObject)
    : iObject(aObject)
{
    Q_ASSERT(iObject);
}
...
bool QRestConnection::operator!() const {
    return !isValid();
}
bool QRestConnection::isValid() const {
    return object()->isValid();
}

QRestOperation QRestConnection::restRequest(const QRestRequest &aRequest) {
    return QRestOperation(object()->restRequest(aRequest.object()));
}

const QRestConnectionObject* QRestConnection::object() const {
    return iObject;
}
QRestConnectionObject* QRestConnection::object() {
    return iObject;
}
