...
#ifndef QCLOUDSERVICES_QENGINIOUSER_OBJECT_H
#define QCLOUDSERVICES_QENGINIOUSER_OBJECT_H
...
public:
    QEnginioUserObject(QObject *aParent = 0);
    QEnginioUserObject(const QJsonObject &aJsonObject,QObject *aParent = 0);
...
#endif /* QCLOUDSERVICES_QENGINIOUSER_OBJECT_H */
