...
#ifndef QCLOUDSERVICES_QRESTENDPOINT_OBJECT_P_H
#define QCLOUDSERVICES_QRESTENDPOINT_OBJECT_P_H
...
class QRestEndpointObjectPrivate : public QObjectPrivate {
...
private:
    QSharedPointer<QRestEndpointShared> iShared;
};

QT_END_NAMESPACE

#endif /* QCLOUDSERVICES_QRESTENDPOINT_OBJECT_P_H */
