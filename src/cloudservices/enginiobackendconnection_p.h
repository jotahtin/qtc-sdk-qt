...
class QTCLOUDSERVICES_EXPORT EnginioBackendConnection : public QObject {
    Q_OBJECT
...
public:
    ...
    bool isConnected()
    {
        return _protocolDecodeState > HandshakePending;
    }
    void connectToBackend(QEnginioConnectionPrivate *client, const QJsonObject& messageFilter = QJsonObject());
    void connectToBackend(QEnginioConnection *client, const QJsonObject& messageFilter = QJsonObject());
...
private slots:
    void onEnginioFinished(QEnginioOperation *);
